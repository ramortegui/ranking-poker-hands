...
describe HandProcess do
  ...
  describe "best hand" do
    it "get the best hand" do
      hand_process = HandProcess.new(["JH","QD","KH","AH","DH"])
      expect(hand_process.best_hand).to eq "high_card"
      hand_process = HandProcess.new(["JH","JH","6D","4H","5H"])
      expect(hand_process.best_hand).to eq "pair"
      hand_process  = HandProcess.new(["3S","2S","4S","5S","6S"])
      expect(hand_process.best_hand).to eq "straigh_flush"
